...
inline size_t index_size() {
    ...
    rt_size += bench::common::recordsInInternals * (sizeof(Box) + sizeof(void *));
    rt_size += bench::common::recordsInLeaves * (sizeof(Box) + sizeof(LeafNode));
    rt_size += bench::common::recordsInLeaves * (LeafNodeCap * (sizeof(Point) + sizeof(size_t) + sizeof(Points)));
